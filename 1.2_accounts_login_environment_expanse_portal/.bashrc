...
alias jupyter-nairr-gpu-shared-llm="galyleo launch --account ${CIML26_ACCOUNT} --reservation ${CIML26_RES_GPU} --partition nairr-gpu-shared --qos ${CIML26_QOS_GPU} --cpus 8 --memory 96 --gpus 1 --time-limit 04:00:00 --sif ${CIML26_DATA_DIR}/ollama-latest-expanse.sif --nv --bind /expanse,/scratch,/cm --quiet"
